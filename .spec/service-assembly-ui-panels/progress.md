...
| 3 | 会话概览 | `panel-sessions` | list | sessionMessages/sessionIdentity（payload 需 sessionId，需评估卡级选择形态） | ⬜ 候选 |
| 4 | 动态插件 | `panel-dynamic-plugins` | list | dynamicPlugins/dynamicRegistry（rowActions=stop/undefine 属 set 面，评估只读起步） | ⬜ 候选 |
